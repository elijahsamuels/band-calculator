...
function Spreadsheet() {
  ...
  const [commissionBonus, setCommissionBonus] = useState(0);
	...
	// const [bandEssentialCost, setBandEssentialCost] = useState(
	// 	(commission1 + commission2 + soundsystemCost + bandLeaderCost)
	// );
	...
	const bandSpreadsheet = () => {
		...
		for (let i = 1; i <= 20; i++){
			bandSpread.push(<tr key={`${i} piece band`}>
				...
				<td align="left">
					${ Math.floor(((i * baseMusicianRateMarkup) + (i * baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + commission1 + commission2) + (((i * baseMusicianRateMarkup) + (baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + commission1 + commission2) * ( taxRate )))  }
				</td>
				<td align="left">
					${ Math.floor((((i * baseMusicianRateMarkup) + (i * baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + (commission1 + commission2)) + (((i * baseMusicianRateMarkup) + (baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + (commission1 + commission2)) * ( taxRate ))) * 0.2) }
				</td>
				<td align="left">
					${ Math.floor(((i * baseMusicianRateMarkup) + (i * baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + (commission1 + commission2)) + (((i * baseMusicianRateMarkup) + (baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + (commission1 + commission2)) * ( taxRate ))) - 
					Math.floor((((i * baseMusicianRateMarkup) + (i * baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + (commission1 + commission2)) + (((i * baseMusicianRateMarkup) + (baseTravelCostPerMusicianMarkup * baseTravelTime) + soundsystemCostMarkup + bandLeaderCostMarkup + (commission1 + commission2)) * ( taxRate ))) * 0.2)
